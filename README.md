...
```bash
curl -X POST http://localhost:8000/api/intent/route -H 'Content-Type: application/json' -d '{"text":"生成季度销售报告"}'
# 预期: {"routed":true,"intent":"generate_report","steps":[...],...}
```
